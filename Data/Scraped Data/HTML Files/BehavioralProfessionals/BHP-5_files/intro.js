  ...
  function _setHelperLayerPosition(helperLayer) {
    if (helperLayer) {
      ...
      helperLayer.setAttribute('style', 'width: ' + (elementPosition.width  + widthHeightPadding)  + 'px; ' +
                                        'height:' + (elementPosition.width + widthHeightPadding)  + 'px; ' +
                                        'top:'    + (elementPosition.top    - ((elementPosition.width - elementPosition.height + widthHeightPadding)/2))   + 'px;' +
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      var oldHelperNumberLayer = oldReferenceLayer.querySelector('.introjs-helperNumberLayer'),
          oldHeaderLayer       = oldReferenceLayer.querySelector('.introjs-tooltipHeader'),
      ...
      self._lastShowElementTimer = setTimeout(function() {
        ...
        oldHeaderLayer.innerHTML = targetElement.header;
      ...
      tooltipHeader.className = 'introjs-tooltipHeader';
      tooltipHeader.innerHTML = targetElement.header;
      ...
      tooltipLayer.appendChild(tooltipHeader);
    ...
    if (this._currentStep == 0 && this._introItems.length > 1) {
      ...
      if (this._options.hideNext == true) {
        ...
        prevTooltipButton.className += ' hideNext';
      }
